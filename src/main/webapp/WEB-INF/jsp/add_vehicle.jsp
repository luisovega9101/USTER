...
</br><h3><center><spring:message code="label.selection1a"/></center></h3></br>

<div class="container col-lg-5">
	<form:form action="add_vehicle.html" modelAttribute="vehicles" method="POST">
		
		<input type="hidden" name="id" value="${vehicles.id}" />
		
		<div class="form-group">
			<label for="brand"><b><spring:message code="col2.veh" />*</b></label>
		...
		<div class="form-group">
			<label for="model"><b><spring:message code="col3.veh" /></b></label>
		...
		<div class="form-group">
			<label for="plate"><b><spring:message code="col4.veh" /></b></label>
		...
		<div class="form-group">
			<label for="licenseRequired"><b><spring:message code="col5.veh" /></b></label>
