...
</br><h3><center><spring:message code="label.selection2c"/></center></h3></br>

<div class="container col-lg-5">
	<form:form action="edit_driver.html" modelAttribute="drivers" method="POST">
	
		<input type="hidden" name="id" value="${drivers.id}" />
		
		<div class="form-group">
			<label for="name"><spring:message code="col2.driv" /></label>
		...
		<div class="form-group">
			<label for="surname"><spring:message code="col3.driv" /></label>
		...
		<div class="form-group">
			<label for="license"><spring:message code="col4.driv" /></label>
